...
// Page d'inscription avec email/mot de passe et Google OAuth
function Signup() {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center bg-white rounded-2xl shadow-lg p-8">
          ...
          <h2 className="font-title text-2xl font-bold text-text mb-2">Vérifie tes emails !</h2>
          <p className="font-body text-gray-500">
            Un lien de confirmation a été envoyé à <strong>{email}</strong>.
            Clique dessus pour activer ton compte.
          </p>
          <Link to="/login" className="inline-block mt-6 text-primary font-medium font-body hover:underline">
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2 font-body">Commence à apprendre gratuitement</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Messages d'erreur */}
            {(localError || error) && (
              <p className="text-red-500 text-sm font-body">{localError || error}</p>
            )}
